...
namespace Vaquinha.Unit.Tests.DomainTests
{
                              ...
                              IClassFixture<CartaoCreditoFixture>
    {
        ...
        [Fact]
        [Trait("Doacao", "Doacao_UsuarioAceitaPagarComTaxa_Doacao_Valida")]
        public void Doacao_UsuarioAceitaPagarComTaxa_Doacao_Valida()
        {
            // Arrange
            var doacao = _doacaoFixture.DoacaoValida(false, 5.0, false, true);
            doacao.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacao.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());
